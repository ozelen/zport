...
class CertificationsControllerTest < ActionController::TestCase
  ...
  test "should create certification" do
    assert_difference('Certification.count') do
      post :create, certification: { description: @certification.description, link: @certification.link, max_value: @certification.max_value, name: @certification.name, value: @certification.value }
    end
  ...
  test "should update certification" do
    patch :update, id: @certification, certification: { description: @certification.description, link: @certification.link, max_value: @certification.max_value, name: @certification.name, value: @certification.value }
    assert_redirected_to certification_path(assigns(:certification))
  end
